        ...
        <div className="hero grid md:grid-cols-2 grid-cols-1 items-center gap-20 pt-32">
          <div className="box">
            ...
            <p className="text-base/8 mb-7">
              ...
              Consequatur aspernatur autem itaque, corrupti sapiente nisi
              doloremque corporis laudantium alias tenetur!
            </p>
            <a
              href="#"
          ...
          <div className="box">
            <img
              src={HeroImage}
              alt="Hero Image"
              className="md:w-full w-[400px] mx-auto"
            />
          </div>
        </div>
          ...
          <div className="services-box pt-12 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              ...
              <p className="text-white text-base/loose ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Eligendi earum temporibus similique veniam deleniti rerum.
              </p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
        ...
        <div className="proyek pt-32" id="proyek">
          ...
          <div className="proyek-box pt-12 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box p-2 bg-white shadow">
              <img src={Proyek1} alt="Proyek Image 1" className="w-full h-[220px]"/>
              <h3 className="text-xl font-bold mt-6 mb-2">Proyek Name 1</h3>
              <p className="text-base/loose">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Reiciendis eius hic libero nesciunt molestiae minima.
              </p>
            </div>
            <div className="box p-2 bg-white shadow">
              <img src={Proyek2} alt="Proyek Image 2" className="w-full h-[220px]" />
            ...
            <div className="box p-2 bg-white shadow">
              <img src={Proyek3} alt="Proyek Image 3" className="w-full h-[220px]" />
            ...
            <div className="box p-2 bg-white shadow">
              <img src={Proyek4} alt="Proyek Image 4" className="w-full h-[220px]"/>
            ...
            <div className="box p-2 bg-white shadow">
              <img src={Proyek5} alt="Proyek Image 5" className="w-full h-[220px]"/>
